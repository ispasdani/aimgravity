...
export class Engine {
  ...
  render() {
    ...
    translateMat4(this.weaponModelMatrix, this.weaponModelMatrix, [0.15, -0.15, -0.35]);
    rotateYMat4(this.weaponModelMatrix, this.weaponModelMatrix, -0.1); 
    scaleMat4(this.weaponModelMatrix, this.weaponModelMatrix, [1.2, 1.2, 1.2]);
